    ...
    for k in range(len(events)):
        ...
        for i in range(len(laps)-1):
            if (laps.loc[i+1,"DriverNumber"] == laps.loc[i,"DriverNumber"]):
                ...
                raceData.loc[index] = ({"Event":Event,"LapTime":LapTime,"NextLapTime":NextLapTime, "LapNumber": LapNumber, "DriverNumber":DriverNumber,"Team": Team, "Compound":Compound,
...
raceData.to_csv("./raceData2019.csv")
